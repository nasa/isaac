...
parser = argparse.ArgumentParser(description='Convert cameras to the format of texrecon.')
...
parser.add_argument('--undistorted_image_dir', default = '', help='The directory containing the undistorted images.')
parser.add_argument('--camera_type', default = '', help='The camera type (nav_cam, haz_cam, or sci_cam).')

args = parser.parse_args()

if args.camera_dir == "" or args.undistorted_image_dir == "" or args.camera_type == "":
    print("Must specify the camera directory, directory of undistorted images, and camera type.")
    sys.exit(1)

if args.camera_type != "nav_cam"  and args.camera_type != "haz_cam" \
...
with open(index_file, "r") as f:
    for image_file in f:
        ...
        with open(out_cam, 'w') as f:
            ...
            # translation
            f.write("%0.17g %0.17g %0.17g " % \
                    (M[0][3], M[1][3], M[2][3]))

            # rotation
            f.write("%0.17g %0.17g %0.17g %0.17g %0.17g %0.17g %0.17g %0.17g %0.17g\n" % \
                    (M[0][0], M[0][1], M[0][2],
                     M[1][0], M[1][1], M[1][2],
                     M[2][0], M[2][1], M[2][2]))

            # normaized inrinsics
            f.write("%0.17g %0.17g %0.17g %0.17g %0.17g %0.17g\n" % \
