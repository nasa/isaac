...
;; goals:
;; 
;; - {type: panorama, robot: bumble, order: o0, location: jem_bay4, run: run1}
;; - {type: panorama, robot: bumble, order: o1, location: jem_bay3, run: run1}
;; - {type: panorama, robot: bumble, order: o2, location: jem_bay2, run: run1}
;; - {type: panorama, robot: bumble, order: o3, location: jem_bay1, run: run1}
;; - {type: stereo, robot: bumble, order: o4, trajectory: jem_bay1_to_bay3, run: run1}
;; 
...
;; 
;; - {type: panorama, robot: honey, order: o0, location: jem_bay7, run: run1}
;; - {type: panorama, robot: honey, order: o1, location: jem_bay6, run: run1}
;; - {type: panorama, robot: honey, order: o2, location: jem_bay5, run: run1}
;; 
...
;; # - {type: stereo, robot: honey, order: o3, trajectory: jem_bay4_to_bay7, run: run1}
;; 
