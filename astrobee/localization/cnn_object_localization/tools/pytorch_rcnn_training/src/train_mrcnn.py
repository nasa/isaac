...
def main(
    ...
    label_dict = {39: 1, 137: 2, 102: 3, 85: 4, 255: 1, 101: 1}
    dataset = AstrobeeHandrailDataset(dataset_path, get_transform(train=True), label_dict=label_dict, images_dir="images", masks_dir="colored_maps")
    dataset_test = AstrobeeHandrailDataset(dataset_path, get_transform(train=False), label_dict=label_dict, images_dir="images", masks_dir="colored_maps")
