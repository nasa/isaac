...
;; Command was: src/survey_planner/problem_generator.py --config=data/survey_static.yaml,data/test_cases/proactive2_config.yaml --output=data/test_cases/proactive2_problem.pddl
;; Working directory was: data/test_cases
;; Problem template: ../../pddl/jem_survey_template.pddl
;; Config 1: data/survey_static.yaml
;; Config 2: data/test_cases/proactive2_config.yaml
...
(define (problem jem-survey)
    ...
    (:goal
        (and
            ...
            (completed-panorama honey o0 jem_bay5)
        )
    )
    ...
    (:init
        ...
        (robot-at bumble jem_bay5)
        (robot-at honey jem_bay3)
