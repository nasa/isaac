...
;; Command was: src/survey_planner/problem_generator.py --config=data/survey_static.yaml,data/test_cases/proactive3_config.yaml --output=data/test_cases/proactive3_problem.pddl
;; Working directory was: data/test_cases
;; Problem template: ../../pddl/jem_survey_template.pddl
;; Config 1: data/survey_static.yaml
;; Config 2: data/test_cases/proactive3_config.yaml
...
(define (problem jem-survey)
    ...
    (:goal
        (and
            (completed-panorama bumble o0 jem_bay3)
            (completed-stereo honey o0 jem_bay1 jem_bay4)
        )
    )
    ...
    (:init
        ...
        (need-stereo honey o0 jem_bay1 jem_bay4)
