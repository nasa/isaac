...
// This code used to project a camera image onto a plane most aligned
// to the mesh portion seen in the current camera view. It is no
// longer needed, it is broken, but may be of use one day.
...
int main(int argc, char** argv) {
  std::cout << "This code is broken and commented out." << std::endl;
}
